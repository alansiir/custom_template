...
export const componentsData = [
    { type: 'Template', label: 'table', component: 'app-table-comp', styles: { zoom: '0.3 ' } },
  
    { type: 'Button', label: 'button', component: 'button',
         styles: { width: '100px', height: '30px', backgroundColor: '#183149', borderRadius: '8px', border: '0px', color: '#FFF' } },
      

    { type: 'Shape', label: 'circle', component: 'div', styles: { width: '70px', height: '70px', borderRadius: '50%', backgroundColor: 'rgb(146, 146, 146)' } },
    { type: 'Shape', label: 'rectangle', component: 'div', styles: { width: '100px', height: '50px', backgroundColor: 'rgb(146, 146, 146)' } },
    { type: 'Shape', label: 'rounded rectangle', component: 'div', styles: { width: '100px', height: '50px', borderRadius: '15px', backgroundColor: 'rgb(146, 146, 146)' } },
    { type: 'Shape', label: 'horizontal line', component: 'div', styles: { width: '100px', height: '2px', backgroundColor: 'rgb(146, 146, 146)' } },
    ...
    { type: 'Icon', label: 'Menu', component: 'i', styles: { fontSize: '24px', color: 'rgb(146, 146, 146)' }, icon: 'mdi:menu' },
    { type: 'Icon', label: 'Phone', component: 'i', styles: { fontSize: '24px', color: 'rgb(146, 146, 146)' }, icon: 'mdi:phone' },
    { type: 'Icon', label: 'Time', component: 'i', styles: { fontSize: '24px', color: 'rgb(146, 146, 146)'}, icon: 'mdi:access-time' },
    ...
    // Navbar Template
    {
      ...
      content: [
        ...
        {
          component: 'ul',
          styles: { display: 'flex', listStyle: 'none', margin: '0', padding: '0' },
          content: [
            {
              component: 'li',
